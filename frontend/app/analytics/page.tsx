    ...
    return (
        ...
        >
            <div className="space-y-6">
                ...
                {/* AI Query - Link to Chat Page */}
                <div className="bg-gradient-to-r from-emerald-500/10 to-teal-500/10 border border-emerald-500/20 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <h2 className="text-sm font-medium text-white mb-1">Need Financial Advice?</h2>
                            <p className="text-xs text-[#71717a]">Ask our AI advisor for budget plans, savings tips, and spending insights.</p>
                        </div>
                        <a
                            href="/chat"
