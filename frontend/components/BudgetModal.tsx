...
export default function BudgetModal({ onClose, onSuccess }: BudgetModalProps) {
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            setBudgets(budgets.filter(b => b.category !== deleteCategory));
    ...
    return (
        <>
                                    ...
                                    budgets.map(b => (
                                        <div key={b.id} className="flex items-center justify-between p-3 bg-[#0f0f0f] border border-[#262626] rounded-md">
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <button
                                                    onClick={() => setDeleteCategory(b.category)}
            ...
            <ConfirmModal
                ...
                title="Delete Budget"
                message={`Are you sure you want to delete the budget for "${deleteCategory}"? This action cannot be undone.`}
